...
chromium-browser --new-window --window-position=0,0 --window-size=1080,2160 --incognito --user-data-dir=/home/$USER/.config/chromium1 \
...
chromium-browser --new-window --window-position=0,1281 --window-size=1080,2160 --incognito --user-data-dir=/home/$USER/.config/chromium2 \
--enable-features=OverlayScrollbar,OverlayScrollbarFlashAfterAnyScrollUpdate,OverlayScrollbarFlashWhenMouseEnter \
--app=https://www.cnbc.com/us-markets/ &

chromium-browser --new-window --window-position=0,2562 --window-size=1080,2160 --incognito --user-data-dir=/home/$USER/.config/chromium3 \
--enable-features=OverlayScrollbar,OverlayScrollbarFlashAfterAnyScrollUpdate,OverlayScrollbarFlashWhenMouseEnter \
